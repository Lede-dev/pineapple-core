...
public class PlayerDeftnessSkillMenu {

    public static final String TITLE = Color.colored("&8손재주스킬");
    ...
    private static void setupIcons(@NotNull Inventory inv, @NotNull OfflinePlayer target) {
        ...
        MenuConfig.MenuIconGroup config = MenuConfig.getDeftnessConfig();
        ...
        for (Map.Entry<SkillConfig.Type, MenuConfig.MenuIcon> entry : icons.entrySet()) {
            ...
            if (skill.hasDeftnessSkill(type)) {
