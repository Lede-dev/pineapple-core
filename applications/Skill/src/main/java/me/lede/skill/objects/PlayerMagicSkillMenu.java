...
public class PlayerMagicSkillMenu {

    public static final String TITLE = Color.colored("&8마법스킬");
    ...
    private static void setupIcons(@NotNull Inventory inv, @NotNull OfflinePlayer target) {
        ...
        MenuConfig.MenuIconGroup config = MenuConfig.getMagicConfig();
