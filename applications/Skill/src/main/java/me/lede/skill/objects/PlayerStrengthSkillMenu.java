...
public class PlayerStrengthSkillMenu {

    public static final String TITLE = Color.colored("&8근력스킬");
    ...
    private static void setupIcons(@NotNull Inventory inv, @NotNull OfflinePlayer target) {
        ...
        MenuConfig.MenuIconGroup config = MenuConfig.getStrengthConfig();
        ...
        for (Map.Entry<SkillConfig.Type, MenuConfig.MenuIcon> entry : icons.entrySet()) {
            ...
            if (skill.hasStrengthSkill(type)) {
